...
-  *  * Инициализация подключения: *  *  создание, чтение, обновление и удаление проектов в системе Vitro-CAD.
-  *  * Управление документами: *  *  создание, чтение, обновление и удаление документов в системе Vitro-CAD.
-  *  * Управление процессами: *  *  создание, чтение, обновление и удаление процессов в системе Vitro-CAD.
-  *  * Аутентификация: *  *  аутентификация пользователя в системе Vitro-CAD.
-  *  * Логирование: *  *  возможность логирования всех запросов к API Vitro-CAD.
